...
.factory('suppliers', function($resource, server_config) {
	return $resource(server_config.url + '/suppliers/:accountid/:supplierid', { account_key : server_config.key, id : '@_id' },
    {
        'update': { method:'PUT' }
    });
})
...
.factory('products', function($resource, server_config) {
	return $resource(server_config.url + '/products/:accountid/:productid', { account_key : server_config.key, id : '@_id' },
    {
        'update': { method:'PUT' }
    });
})
...
.factory('stocks', function($resource, server_config) {
	return $resource(server_config.url + '/stocks/:accountid/:stockid', { account_key : server_config.key, id : '@_id' },
    {
        'update': { method:'PUT' }
    });
})
...
.factory('units', function($resource, server_config) {
	return $resource(server_config.url + '/units/:id', { account_key : server_config.key, id : '@_id' },
    {
        'update': { method:'PUT' }
    });
})
